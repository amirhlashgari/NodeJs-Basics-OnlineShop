...
const stripe = require('stripe')('Your Secret_key');
    ...
    .then(user => {
      ...
      return stripe.checkout.sessions.create({
        ...
        line_items: products.map(p => {
          return { name: p.productId.title, description: p.productId.description, amount: p.productId.price * 100, currency: 'usd', quantity: p.quantity };
        }),
